...
$(document).ready(function() {
	...
	$("#button1").click(function() {
		$("#div2").css({"background-color":colors[div1index]});
		div1index = IncrementColor(div1index);
	});
	$("#button2").click(function() {
		$("#div4").css({"background-color":colors[div2index]});
		div2index = IncrementColor(div2index);
	});
	$("#button3").click(function() {
		$("#div1").css({"background-color":colors[div3index]});
		div3index = IncrementColor(div3index);
	});
	$("#button4").click(function() {
		$("#div3").css({"background-color":colors[div4index]});
