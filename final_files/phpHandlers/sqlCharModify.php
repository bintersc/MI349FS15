<?php
	...
	//echo "UPDATE Characters SET player_id=".$_SESSION['user_id'].", char_name='".$char."', player_name='".$player."', race='".$race."', 
						//attributes='".$attr."', base_stats='".$base."', defense_stats='".$def."', weapon_stats='".$weapons."', classes='".$classes."', 
						//skills='".$skills."' WHERE id=".$_SESSION['modify']."";
	$result = $con->query("UPDATE Characters SET player_id=".$_SESSION['user_id'].", char_name='".$char."', player_name='".$player."', race='".$race."', 
						attributes='".$attr."', base_stats='".$base."', defense_stats='".$def."', weapon_stats='".$weapons."', classes='".$classes."', 
						skills='".$skills."' WHERE id=".$_SESSION['modify']."");
	if($result === TRUE)
		echo "Success";
